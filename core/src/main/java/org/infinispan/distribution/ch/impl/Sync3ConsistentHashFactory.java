 ...
 * @since 5.2
 */
public class Sync3ConsistentHashFactory implements ConsistentHashFactory<DefaultConsistentHash> {
   ...
   private static final Log log = LogFactory.getLog(Sync3ConsistentHashFactory.class);
   ...
   public static class Externalizer extends AbstractExternalizer<Sync3ConsistentHashFactory> {

      @Override
      public void writeObject(ObjectOutput output, Sync3ConsistentHashFactory chf) {
      }

      @Override
      @SuppressWarnings("unchecked")
      public Sync3ConsistentHashFactory readObject(ObjectInput unmarshaller) {
         return new Sync3ConsistentHashFactory();
      }
      ...
      @Override
      public Set<Class<? extends Sync3ConsistentHashFactory>> getTypeClasses() {
         return Collections.<Class<? extends Sync3ConsistentHashFactory>>singleton(Sync3ConsistentHashFactory.class);
      }
   }
}
